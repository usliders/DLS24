...
- **🎬⚡ Демо модель переноса + NST**    
 ...
 ```bash
 🎬 Демо проекта можно посмотреть отдельно, если клонируете репозиторий
    DLS24/
    ├── tests/
    │   ├── docs/
    │       ├── video_demos/
    │           ├── 🔊 Проект 2024 Demo голосовое колаб перенос 2023-converted.mp4
    │           ├── 🎨 Проект 2024 Demo Fooocus колаб-converted.mp4
    │           ├── ⚡ Проект 2024 Demo локальный GPU колаб закончился-converted.mp4
```	
---
