...
![Demo Workflow]("docs/Проект 2024 Demo голосовое колаб перенос 2023.wmv") *Пример работы бота 1*
![Demo Workflow]("docs/Проект 2024 Demo Fooocus колаб.wmv") *Пример работы бота 2*
![Demo Workflow]("docs/Проект 2024 Demo локальный GPU колаб закончился.wmv") *Пример работы бота 3*
